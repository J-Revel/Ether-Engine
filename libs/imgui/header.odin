...
color_hsv     :: #force_inline proc(pOut: ^Color, self: ^Color, h: f32, s: f32, v: f32, a := f32(1.0)) do ImColor_HSV(pOut, self, h, s, v, a);
...
draw_list_add_bezier_curve             :: #force_inline proc(self: ^Draw_List, p1: Vec2, p2: Vec2, p3: Vec2, p4: Vec2, col: u32, thickness: f32, num_segments := i32(0))                                                        do ImDrawList_AddBezierCurve(self, p1, p2, p3, p4, col, thickness, num_segments);
...
draw_list_add_image                    :: #force_inline proc(self: ^Draw_List, user_texture_id: Texture_ID, p_min: Vec2, p_max: Vec2, uv_min := Vec2(Vec2 {0,0}), uv_max := Vec2(Vec2 {1,1}), col: u32)                         do ImDrawList_AddImage(self, user_texture_id, p_min, p_max, uv_min, uv_max, col);
draw_list_add_image_quad               :: #force_inline proc(self: ^Draw_List, user_texture_id: Texture_ID, p1: Vec2, p2: Vec2, p3: Vec2, p4: Vec2, uv1 := Vec2(Vec2 {0,0}), uv2 := Vec2(Vec2 {1,0}), uv3 := Vec2(Vec2 {1,1}), uv4 := Vec2(Vec2 {0,1}), col: u32) do ImDrawList_AddImageQuad(self, user_texture_id, p1, p2, p3, p4, uv1, uv2, uv3, uv4, col);
draw_list_add_image_rounded            :: #force_inline proc(self: ^Draw_List, user_texture_id: Texture_ID, p_min: Vec2, p_max: Vec2, uv_min: Vec2, uv_max: Vec2, col: u32, rounding: f32, rounding_corners := Draw_Corner_Flags(Draw_Corner_Flags.All)) do ImDrawList_AddImageRounded(self, user_texture_id, p_min, p_max, uv_min, uv_max, col, rounding, rounding_corners);
...
draw_list_add_polyline                 :: #force_inline proc(self: ^Draw_List, points: ^Vec2, num_points: i32, col: u32, closed: bool, thickness: f32)                                                                          do ImDrawList_AddPolyline(self, points, num_points, col, closed, thickness);
...
draw_list_add_rect                     :: #force_inline proc(self: ^Draw_List, p_min: Vec2, p_max: Vec2, col: u32, rounding := f32(0.0), rounding_corners := Draw_Corner_Flags(Draw_Corner_Flags.All), thickness := f32(1.0))   do ImDrawList_AddRect(self, p_min, p_max, col, rounding, rounding_corners, thickness);
draw_list_add_rect_filled              :: #force_inline proc(self: ^Draw_List, p_min: Vec2, p_max: Vec2, col: u32, rounding := f32(0.0), rounding_corners := Draw_Corner_Flags(Draw_Corner_Flags.All))                          do ImDrawList_AddRectFilled(self, p_min, p_max, col, rounding, rounding_corners);
...
draw_list_add_text_vec2                :: #force_inline proc(self: ^Draw_List, pos: Vec2, col: u32, text_begin: string, text_end := "")                                                                                         do swr_ImDrawList_AddTextVec2(self, pos, col, text_begin, text_end);
draw_list_add_text_font_ptr            :: #force_inline proc(self: ^Draw_List, font: ^ImFont, font_size: f32, pos: Vec2, col: u32, text_begin: string, text_end := "", wrap_width := f32(0.0), cpu_fine_clip_rect : ^Vec4 = nil) do swr_ImDrawList_AddTextFontPtr(self, font, font_size, pos, col, text_begin, text_end, wrap_width, cpu_fine_clip_rect);
...
draw_list_path_arc_to                  :: #force_inline proc(self: ^Draw_List, center: Vec2, radius: f32, a_min: f32, a_max: f32, num_segments := i32(10))                                                                      do ImDrawList_PathArcTo(self, center, radius, a_min, a_max, num_segments);
...
draw_list_path_bezier_curve_to         :: #force_inline proc(self: ^Draw_List, p2: Vec2, p3: Vec2, p4: Vec2, num_segments := i32(0))                                                                                            do ImDrawList_PathBezierCurveTo(self, p2, p3, p4, num_segments);
...
draw_list_path_rect                    :: #force_inline proc(self: ^Draw_List, rect_min: Vec2, rect_max: Vec2, rounding := f32(0.0), rounding_corners := Draw_Corner_Flags(Draw_Corner_Flags.All))                              do ImDrawList_PathRect(self, rect_min, rect_max, rounding, rounding_corners);
draw_list_path_stroke                  :: #force_inline proc(self: ^Draw_List, col: u32, closed: bool, thickness := f32(1.0))                                                                                                   do ImDrawList_PathStroke(self, col, closed, thickness);
...
begin_child_str                        :: #force_inline proc(str_id: string, size := Vec2(Vec2 {0,0}), border := bool(false), flags := Window_Flags(0)) -> bool                                                                     do return swr_igBeginChildStr(str_id, size, border, flags);
begin_child_id                         :: #force_inline proc(id: ImID, size := Vec2(Vec2 {0,0}), border := bool(false), flags := Window_Flags(0)) -> bool                                                                           do return igBeginChildID(id, size, border, flags);
...
checkbox_flags                         :: #force_inline proc(label: string, flags: ^u32, flags_value: u32) -> bool                                                                                                                  do return swr_igCheckboxFlags(label, flags, flags_value);
...
collapsing_header_tree_node_flags      :: #force_inline proc(label: string, flags := Tree_Node_Flags(0)) -> bool                                                                                                                    do return swr_igCollapsingHeaderTreeNodeFlags(label, flags);
collapsing_header_bool_ptr             :: #force_inline proc(label: string, p_open: ^bool, flags := Tree_Node_Flags(0)) -> bool                                                                                                     do return swr_igCollapsingHeaderBoolPtr(label, p_open, flags);
...
combo_str                              :: #force_inline proc(label: string, current_item: ^i32, items_separated_by_zeros: string, popup_max_height_in_items := i32(-1)) -> bool                                                     do return swr_igComboStr(label, current_item, items_separated_by_zeros, popup_max_height_in_items);
...
drag_scalar                            :: #force_inline proc(label: string, data_type: Data_Type, p_data: rawptr, v_speed: f32, p_min : rawptr = nil, p_max : rawptr = nil, format := "", flags := Slider_Flags(0)) -> bool         do return swr_igDragScalar(label, data_type, p_data, v_speed, p_min, p_max, format, flags);
drag_scalar_n                          :: #force_inline proc(label: string, data_type: Data_Type, p_data: rawptr, components: i32, v_speed: f32, p_min : rawptr = nil, p_max : rawptr = nil, format := "", flags := Slider_Flags(0)) -> bool do return swr_igDragScalarN(label, data_type, p_data, components, v_speed, p_min, p_max, format, flags);
...
get_background_draw_list               :: #force_inline proc() -> ^Draw_List                                                                                                                                                        do return igGetBackgroundDrawList();
...
get_color_u32col                       :: #force_inline proc(idx: Col, alpha_mul := f32(1.0)) -> u32                                                                                                                                do return igGetColorU32Col(idx, alpha_mul);
get_color_u32vec4                      :: #force_inline proc(col: Vec4) -> u32                                                                                                                                                      do return igGetColorU32Vec4(col);
get_color_u32u32                       :: #force_inline proc(col: u32) -> u32                                                                                                                                                       do return igGetColorU32U32(col);
...
get_foreground_draw_list_nil           :: #force_inline proc() -> ^Draw_List                                                                                                                                                        do return igGetForegroundDrawListNil();
...
get_id_str                             :: #force_inline proc(str_id: string) -> ImID                                                                                                                                                do return swr_igGetIDStr(str_id);
get_id_str_str                         :: #force_inline proc(str_id_begin: string, str_id_end: string) -> ImID                                                                                                                      do return swr_igGetIDStrStr(str_id_begin, str_id_end);
get_id_ptr                             :: #force_inline proc(ptr_id: rawptr) -> ImID                                                                                                                                                do return igGetIDPtr(ptr_id);
...
input_string                           :: #force_inline proc(label: string, value: ^string, max_length: int = 100, flags := Input_Text_Flags(0), callback : Input_Text_Callback = nil, user_data : rawptr = nil) -> bool                                        
{
...
is_popup_open_str                      :: #force_inline proc(str_id: string, flags := Popup_Flags(0)) -> bool                                                                                                                       do return swr_igIsPopupOpenStr(str_id, flags);
...
is_rect_visible_nil                    :: #force_inline proc(size: Vec2) -> bool                                                                                                                                                    do return igIsRectVisibleNil(size);
is_rect_visible_vec2                   :: #force_inline proc(rect_min: Vec2, rect_max: Vec2) -> bool                                                                                                                                do return igIsRectVisibleVec2(rect_min, rect_max);
...
list_box_str_arr                       :: #force_inline proc(label: string, current_item: ^i32, items: string, items_count: i32, height_in_items := i32(-1)) -> bool                                                                do return swr_igListBoxStr_arr(label, current_item, items, items_count, height_in_items);
...
list_box_footer                        :: #force_inline proc()                                                                                                                                                                      do igListBoxFooter();

list_box_header :: proc {
	list_box_header_vec2,
	list_box_header_int,
};
list_box_header_vec2                   :: #force_inline proc(label: string, size := Vec2(Vec2 {0,0})) -> bool                                                                                                                       do return swr_igListBoxHeaderVec2(label, size);
list_box_header_int                    :: #force_inline proc(label: string, items_count: i32, height_in_items := i32(-1)) -> bool                                                                                                   do return swr_igListBoxHeaderInt(label, items_count, height_in_items);
...
menu_item_bool                         :: #force_inline proc(label: string, shortcut := "", selected := bool(false), enabled := bool(true)) -> bool                                                                                 do return swr_igMenuItemBool(label, shortcut, selected, enabled);
menu_item_bool_ptr                     :: #force_inline proc(label: string, shortcut: string, p_selected: ^bool, enabled := bool(true)) -> bool                                                                                     do return swr_igMenuItemBoolPtr(label, shortcut, p_selected, enabled);
...
open_popup_context_item                :: #force_inline proc(str_id := "", popup_flags := Popup_Flags(1)) -> bool                                                                                                                   do return swr_igOpenPopupContextItem(str_id, popup_flags);
...
progress_bar                           :: #force_inline proc(fraction: f32, size_arg := Vec2(Vec2 {-1,0}), overlay := "")                                                                                                           do swr_igProgressBar(fraction, size_arg, overlay);
...
push_id_str                            :: #force_inline proc(str_id: string)                                                                                                                                                        do swr_igPushIDStr(str_id);
push_id_str_str                        :: #force_inline proc(str_id_begin: string, str_id_end: string)                                                                                                                              do swr_igPushIDStrStr(str_id_begin, str_id_end);
push_id_ptr                            :: #force_inline proc(ptr_id: rawptr)                                                                                                                                                        do igPushIDPtr(ptr_id);
push_id_int                            :: #force_inline proc(int_id: i32)                                                                                                                                                           do igPushIDInt(int_id);
...
push_style_color_u32                   :: #force_inline proc(idx: Col, col: u32)                                                                                                                                                    do igPushStyleColorU32(idx, col);
push_style_color_vec4                  :: #force_inline proc(idx: Col, col: Vec4)                                                                                                                                                   do igPushStyleColorVec4(idx, col);
...
push_style_var_float                   :: #force_inline proc(idx: Style_Var, val: f32)                                                                                                                                              do igPushStyleVarFloat(idx, val);
push_style_var_vec2                    :: #force_inline proc(idx: Style_Var, val: Vec2)                                                                                                                                             do igPushStyleVarVec2(idx, val);
...
radio_button_bool                      :: #force_inline proc(label: string, active: bool) -> bool                                                                                                                                   do return swr_igRadioButtonBool(label, active);
radio_button_int_ptr                   :: #force_inline proc(label: string, v: ^i32, v_button: i32) -> bool                                                                                                                         do return swr_igRadioButtonIntPtr(label, v, v_button);
...
selectable_bool                        :: #force_inline proc(label: string, selected := bool(false), flags := Selectable_Flags(0), size := Vec2(Vec2 {0,0})) -> bool                                                                do return swr_igSelectableBool(label, selected, flags, size);
selectable_bool_ptr                    :: #force_inline proc(label: string, p_selected: ^bool, flags := Selectable_Flags(0), size := Vec2(Vec2 {0,0})) -> bool                                                                      do return swr_igSelectableBoolPtr(label, p_selected, flags, size);
...
set_scroll_from_pos_x_float            :: #force_inline proc(local_x: f32, center_x_ratio := f32(0.5))                                                                                                                              do igSetScrollFromPosXFloat(local_x, center_x_ratio);


set_scroll_from_pos_y :: proc {
	set_scroll_from_pos_y_float,
};
set_scroll_from_pos_y_float            :: #force_inline proc(local_y: f32, center_y_ratio := f32(0.5))                                                                                                                              do igSetScrollFromPosYFloat(local_y, center_y_ratio);
...
set_scroll_x_float                     :: #force_inline proc(scroll_x: f32)                                                                                                                                                         do igSetScrollXFloat(scroll_x);


set_scroll_y :: proc {
	set_scroll_y_float,
};
set_scroll_y_float                     :: #force_inline proc(scroll_y: f32)                                                                                                                                                         do igSetScrollYFloat(scroll_y);
...
set_window_collapsed_bool              :: #force_inline proc(collapsed: bool, cond := Cond(0))                                                                                                                                      do igSetWindowCollapsedBool(collapsed, cond);
set_window_collapsed_str               :: #force_inline proc(name: string, collapsed: bool, cond := Cond(0))                                                                                                                        do swr_igSetWindowCollapsedStr(name, collapsed, cond);
...
set_window_focus_nil                   :: #force_inline proc()                                                                                                                                                                      do igSetWindowFocusNil();
set_window_focus_str                   :: #force_inline proc(name: string)                                                                                                                                                          do swr_igSetWindowFocusStr(name);
...
set_window_pos_vec2                    :: #force_inline proc(pos: Vec2, cond := Cond(0))                                                                                                                                            do igSetWindowPosVec2(pos, cond);
set_window_pos_str                     :: #force_inline proc(name: string, pos: Vec2, cond := Cond(0))                                                                                                                              do swr_igSetWindowPosStr(name, pos, cond);
...
set_window_size_vec2                   :: #force_inline proc(size: Vec2, cond := Cond(0))                                                                                                                                           do igSetWindowSizeVec2(size, cond);
set_window_size_str                    :: #force_inline proc(name: string, size: Vec2, cond := Cond(0))                                                                                                                             do swr_igSetWindowSizeStr(name, size, cond);
...
tree_node_str                          :: #force_inline proc(label: string) -> bool                                                                                                                                                 do return swr_igTreeNodeStr(label);
tree_node_str_str                      :: #force_inline proc(str_id: string, fmt_: string, args: ..any) -> bool                                                                                                                     do return swr_igTreeNodeStrStr(str_id, fmt_, args);
tree_node_ptr                          :: #force_inline proc(ptr_id: rawptr, fmt_: string, args: ..any) -> bool                                                                                                                     do return swr_igTreeNodePtr(ptr_id, fmt_, args);
...
tree_node_ex_str                       :: #force_inline proc(label: string, flags := Tree_Node_Flags(0)) -> bool                                                                                                                    do return swr_igTreeNodeExStr(label, flags);
tree_node_ex_str_str                   :: #force_inline proc(str_id: string, flags: Tree_Node_Flags, fmt_: string, args: ..any) -> bool                                                                                             do return swr_igTreeNodeExStrStr(str_id, flags, fmt_, args);
tree_node_ex_ptr                       :: #force_inline proc(ptr_id: rawptr, flags: Tree_Node_Flags, fmt_: string, args: ..any) -> bool                                                                                             do return swr_igTreeNodeExPtr(ptr_id, flags, fmt_, args);
...
tree_push_str                          :: #force_inline proc(str_id: string)                                                                                                                                                        do swr_igTreePushStr(str_id);
tree_push_ptr                          :: #force_inline proc(ptr_id : rawptr = nil)                                                                                                                                                 do igTreePushPtr(ptr_id);
...
value_bool                             :: #force_inline proc(prefix: string, b: bool)                                                                                                                                               do swr_igValueBool(prefix, b);
value_int                              :: #force_inline proc(prefix: string, v: i32)                                                                                                                                                do swr_igValueInt(prefix, v);
value_uint                             :: #force_inline proc(prefix: string, v: u32)                                                                                                                                                do swr_igValueUint(prefix, v);
value_float                            :: #force_inline proc(prefix: string, v: f32, float_format := "")                                                                                                                            do swr_igValueFloat(prefix, v, float_format);
